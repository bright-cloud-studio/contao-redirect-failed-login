...
class ModAddMeetings extends \Contao\Module
{
    ...
    protected function compile()
    {
        ...
        $spreadsheet = $this->$service->spreadsheets->get(ModAddMeetings::$spreadsheetId);
        
        // get all of our unarchived Transactions
        $range = 'Work Assignment';
        $response = $this->$service->spreadsheets_values->get(ModAddMeetings::$spreadsheetId, $range);
